# @shapeshift-labs/frontier-lang-csharp Agent Notes
...
Use `main` as the default GitHub branch. This package should publish as `@shapeshift-labs/frontier-lang-csharp` and push to `git@github.com:siliconjungle/-shapeshift-labs-frontier-lang-csharp.git`.
